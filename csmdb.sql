...
INSERT INTO `bid` VALUES ('abcde',1,10000000,'','2022-07-31 22:36:35',0),('abcde',3,8000000,'','2022-08-03 23:36:18',1),('abcde',16,50000000,'','2022-08-12 20:46:37',0),('abcdef',2,2500000,'','2022-08-01 20:32:38',1);
...
INSERT INTO `post` VALUES (1,'Bữa sáng của tôi #sharinghope #test','https://res.cloudinary.com/dynupxxry/image/upload/v1657817663/cld-sample-4.jpg','2022-07-26 07:00:00','abcd',1,'#sharinghope #test '),(2,'Chuyến đi đầu tiên của tôi  #sharinghope','https://res.cloudinary.com/dynupxxry/image/upload/v1657817637/sample.jpg','2022-08-10 00:45:42','abcd',1,'#sharinghope#Test1 #Test2 '),(3,'Ngày mới #love','https://res.cloudinary.com/dynupxxry/image/upload/v1657817662/cld-sample-3.jpg','2022-07-27 00:00:00','abcde',1,'#love '),(36,'Thử đăng bài #test','https://res.cloudinary.com/quoc2401/image/upload/v1659862909/rota7wbbyuhclwa3tvry.jpg?public_id=rota7wbbyuhclwa3tvry','2022-08-07 16:01:50','abcde',1,'#test '),(37,'dep ha #love','https://res.cloudinary.com/quoc2401/image/upload/v1659966642/exarcc2xsetmvlnqigug.jpg?public_id=exarcc2xsetmvlnqigug','2022-08-08 20:50:45','abcde',1,'#love '),(48,'#sharinghope #test','','2022-08-11 19:40:35','abcd',1,'#sharinghope #test '),(49,'#sharinghope #test2','','2022-08-11 19:43:29','abcd',1,'#sharinghope #test2 ');
...
CREATE TABLE `report_auction` (
  ...
  `auction_id` int NOT NULL,
  `user_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `reason` enum('IMAGE','CONTENT','SPAM') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `report_user` (
  ...
  `user_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `reason` enum('PAY','WORDS') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `is_solve` tinyint DEFAULT '0',
  `reported_date` datetime NOT NULL,
  PRIMARY KEY (`id`),
