...
function commentItem(comment) {
    return `<div class="d-flex flex-column comment--item py-2 position-relative comment--item-have-reply">
                    <div class="d-flex">
                    ...
                    <div class="comment--item-content">
                        <div class="bg-light comment-content">
                            ...
                            <div class="count-like-comment bg-light">
                                ...
                                <span id="count-liked-comment" class="ms-1">24</span>
                            </div>
                        </div>
                          <div class="d-flex justify-content-end me-2">
...
function likedComment(commentItemId) {
    const comment = $(`.comment-like${commentItemId}`);
    
    if (comment.hasClass('liked')) {
        comment.removeClass('liked');
    } else {
        comment.addClass('liked');
    }
}
